...
from .shape import Shape, RectangleShape, CircleShape, PolygonShape, CrossShape, HorizontalGradientShape, VerticalGradientShape, RadialGradientShape, SquaredGradientShape
...
from .sprite import Sprite, SpriteDict
